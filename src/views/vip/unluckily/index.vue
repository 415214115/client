       ...
       <div class="cardTabel">
           <el-card>
			   ...
			   <div class="handleBoxtOP">
				   <div class="handleBox">
					   <div class="handleList" v-for="item in navList" :key="item.id" :class="navIndex==item.id?'selects':''" @click="selectorNav(item.id)">{{ item.title }}</div>
					</div>
					<div class="serchBox">
			...
			<div>
				<el-form label-position="right" :model="formInline" class="demo-form-inline" label-width="110px" size="mini">
				  ...
				  <el-form-item label="银行名称">
				  		<el-input class="inputs"  v-model="formInline.bankName" placeholder="银行名称"></el-input><span class="inputTip">台湾地区可输入代码</span>
				  </el-form-item>
				  <el-form-item label="收款人姓名">
				  		<el-input class="inputs"  v-model="formInline.userName" placeholder="收款人姓名"></el-input><span class="inputTip">台湾地区选填</span>
				  </el-form-item>
				  <el-form-item label="收款账号">
				  		<el-input class="inputs"  v-model="formInline.bankNo" placeholder="收款账号"></el-input>
				  </el-form-item>
				  <el-form-item label="备注">
				  		<el-input class="inputs" type="textarea" autosize v-model="formInline.customerMark" placeholder="备注"></el-input>
				  </el-form-item>
				  <el-form-item label="退款金额">
				  		<el-input class="inputs" v-model="formInline.recordMoney" @blur="getPayMoney" placeholder="退款金额"></el-input><span class="inputTip">请输入当地货币数量！</span>
				  </el-form-item>
				  ...
				  <el-form-item label="">
						...
						<div><span class="inputTip">手续费：{{ arithmetic.customerPoundage }}          汇率：{{ arithmetic.customerRate }}%        手续费：{{ arithmetic.customerServer }}</span></div>
				  </el-form-item>
				</el-form>
			</div>
				...
				if(res.code == 200){
					if(this.formInline.payAway==='0'){
						...
						this.$prompt('请输入交易密码', '提示', {
							...
							this.$publicFonc.balancePayment(value, res.data.money, res.data.orderId).then(data=>{
